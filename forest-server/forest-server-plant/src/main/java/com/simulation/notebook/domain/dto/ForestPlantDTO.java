package com.simulation.notebook.domain.dto;
 ...
 */
@Data
public class ForestPlantDTO implements Serializable {

    private static final long serialVersionUID = -7311655688584651386L;
